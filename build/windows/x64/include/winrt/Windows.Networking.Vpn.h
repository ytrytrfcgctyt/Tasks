...
namespace winrt::impl
{
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::Networking::Vpn::IVpnChannel)->remove_ActivityChange(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::Networking::Vpn::IVpnChannel2)->remove_ActivityStateChange(impl::bind_in(token)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Networking_Vpn_IVpnPlugInReconnectTransport<D>::ReconnectTransport(winrt::Windows::Networking::Vpn::VpnChannel const& channel, winrt::Windows::Foundation::IInspectable const& context) const
    {
