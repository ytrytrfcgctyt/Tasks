...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Media_Core_ICodecSubtypesStatics2<D>::VideoFormatAv1() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Media::Core::ICodecSubtypesStatics2)->get_VideoFormatAv1(&value));
        return hstring{ value, take_ownership_from_abi };
    }
