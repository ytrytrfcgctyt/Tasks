...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Graphics::RectInt32>) consume_Windows_Graphics_Capture_IDirect3D11CaptureFrame2<D>::DirtyRegions() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) consume_Windows_Graphics_Capture_IDirect3D11CaptureFrame2<D>::DirtyRegionMode() const
    {
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::Graphics::Capture::IDirect3D11CaptureFramePool)->remove_FrameArrived(impl::bind_in(token)));
    }
    ...
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::Graphics::Capture::IGraphicsCaptureItem)->remove_Closed(impl::bind_in(token)));
    }
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode) consume_Windows_Graphics_Capture_IGraphicsCaptureSession4<D>::DirtyRegionMode() const
    {
        winrt::Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Graphics_Capture_IGraphicsCaptureSession4<D>::DirtyRegionMode(winrt::Windows::Graphics::Capture::GraphicsCaptureDirtyRegionMode const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) consume_Windows_Graphics_Capture_IGraphicsCaptureSession5<D>::MinUpdateInterval() const
    {
        winrt::Windows::Foundation::TimeSpan value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Graphics_Capture_IGraphicsCaptureSession5<D>::MinUpdateInterval(winrt::Windows::Foundation::TimeSpan const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Graphics_Capture_IGraphicsCaptureSession6<D>::IncludeSecondaryWindows() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Graphics::Capture::IGraphicsCaptureSession6)->get_IncludeSecondaryWindows(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Graphics_Capture_IGraphicsCaptureSession6<D>::IncludeSecondaryWindows(bool value) const
    {
