...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::DeviceId() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Media::Audio::IAudioEffectsPackConfiguration)->get_DeviceId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::EffectsPackId() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Media::Audio::IAudioEffectsPackConfiguration)->get_EffectsPackId(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Media::Audio::AudioEffectsPackStatus) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::Status() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::event_token) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::StatusChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Audio::AudioEffectsPackConfiguration, winrt::Windows::Foundation::IInspectable> const& handler) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Media_Audio_IAudioEffectsPackConfiguration<D>::StatusChanged(winrt::event_token const& token) const noexcept
    {
        WINRT_VERIFY_(0, WINRT_IMPL_SHIM(winrt::Windows::Media::Audio::IAudioEffectsPackConfiguration)->remove_StatusChanged(impl::bind_in(token)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Media::Audio::AudioEffectsPackConfiguration) consume_Windows_Media_Audio_IAudioEffectsPackConfigurationStatics<D>::GetForDeviceId(param::hstring const& effectsPackId, param::hstring const& deviceId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Media_Audio_IAudioEffectsPackConfigurationStatics<D>::IsDeviceIdSupported(param::hstring const& effectsPackId, param::hstring const& deviceId) const
    {
        bool result{};
