...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(uint64_t) consume_Windows_Devices_Printers_IIppPrintDevice2<D>::GetMaxSupportedPdfSize() const
    {
        uint64_t result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice2)->GetMaxSupportedPdfSize(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IIppPrintDevice2<D>::GetMaxSupportedPdfVersion() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice2)->GetMaxSupportedPdfVersion(&result));
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDevice2<D>::IsPdlPassthroughSupported(param::hstring const& pdlContentType) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::PdlPassthroughProvider) consume_Windows_Devices_Printers_IIppPrintDevice2<D>::GetPdlPassthroughProvider() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDevice3<D>::IsIppFaxOutPrinter() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice3)->get_IsIppFaxOutPrinter(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDeviceKind) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::DeviceKind() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::CanModifyUserDefaultPrintTicket() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice4)->get_CanModifyUserDefaultPrintTicket(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::UserDefaultPrintTicket() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::UserDefaultPrintTicket(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice4)->put_UserDefaultPrintTicket(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::RefreshPrintDeviceCapabilities() const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice4)->RefreshPrintDeviceCapabilities());
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IIppPrintDevice4<D>::GetMaxSupportedPdlVersion(param::hstring const& pdlContentType) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::ValueSet) consume_Windows_Devices_Printers_IIppPrintDevice5<D>::GetDeviceProperties() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice5)->GetDeviceProperties(&result));
        return winrt::Windows::Foundation::Collections::ValueSet{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::ReplaceDevicePropertiesResult) consume_Windows_Devices_Printers_IIppPrintDevice5<D>::ReplaceDeviceProperties(param::iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, winrt::Windows::Foundation::IInspectable>> const& deviceProperties) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDevice5)->ReplaceDeviceProperties(*(void**)(&deviceProperties), &result));
        return winrt::Windows::Devices::Printers::ReplaceDevicePropertiesResult{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDeviceInstallationStatus) consume_Windows_Devices_Printers_IIppPrintDeviceInstallationResult<D>::Status() const
    {
        winrt::Windows::Devices::Printers::IppPrintDeviceInstallationStatus value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IIppPrintDeviceInstallationResult<D>::InstalledPrinterName() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_InstalledPrinterName(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::hresult) consume_Windows_Devices_Printers_IIppPrintDeviceInstallationResult<D>::ExtendedError() const
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceInstallationResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDeviceManagerStatics<D>::CanInstallIppPrintDevice() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceManagerStatics)->CanInstallIppPrintDevice(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::IppPrintDeviceInstallationResult>) consume_Windows_Devices_Printers_IIppPrintDeviceManagerStatics<D>::InstallIppPrintDeviceAsync(winrt::Windows::Foundation::Uri const& printerUri, param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceManagerStatics)->InstallIppPrintDeviceAsync(*(void**)(&printerUri), *(void**)(&printerName), &operation));
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::GetDeviceSelector() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IIppPrintDeviceStatics)->GetDeviceSelector(&result));
        return hstring{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDevice) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::FromId(param::hstring const& deviceId) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDevice) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::FromPrinterName(param::hstring const& printerName) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Printers_IIppPrintDeviceStatics<D>::IsIppPrinter(param::hstring const& printerName) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::PageConfigurationSource) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::OrientationSource() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::OrientationSource(winrt::Windows::Devices::Printers::PageConfigurationSource const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::PageConfigurationSource) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::SizeSource() const
    {
        winrt::Windows::Devices::Printers::PageConfigurationSource value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IPageConfigurationSettings<D>::SizeSource(winrt::Windows::Devices::Printers::PageConfigurationSource const& value) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IPdlPassthroughProvider<D>::SupportedPdlContentTypes() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::PdlPassthroughTarget) consume_Windows_Devices_Printers_IPdlPassthroughProvider<D>::StartPrintJobWithPrintTicket(param::hstring const& jobName, param::hstring const& pdlContentType, winrt::Windows::Storage::Streams::IInputStream const& printTicket, winrt::Windows::Devices::Printers::PageConfigurationSettings const& pageConfigurationSettings) const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(int32_t) consume_Windows_Devices_Printers_IPdlPassthroughTarget<D>::PrintJobId() const
    {
        int32_t value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IPdlPassthroughTarget)->get_PrintJobId(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Storage::Streams::IOutputStream) consume_Windows_Devices_Printers_IPdlPassthroughTarget<D>::GetOutputStream() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IPdlPassthroughTarget<D>::Submit() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::ReplaceDevicePropertiesStatus) consume_Windows_Devices_Printers_IReplaceDevicePropertiesResult<D>::Status() const
    {
        winrt::Windows::Devices::Printers::ReplaceDevicePropertiesStatus value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IReplaceDevicePropertiesResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::hresult) consume_Windows_Devices_Printers_IReplaceDevicePropertiesResult<D>::ExtendedError() const
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IReplaceDevicePropertiesResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterName() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrinterName(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterName(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrinterName(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::OutputFileExtensions() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_OutputFileExtensions(&value));
        return winrt::Windows::Foundation::Collections::IVector<hstring>{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Devices::Printers::VirtualPrinterSupportedFormat>) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::SupportedInputFormats() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_SupportedInputFormats(&value));
    ...
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrintDeviceCapabilitiesPackageRelativeFilePath() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrintDeviceCapabilitiesPackageRelativeFilePath(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrintDeviceCapabilitiesPackageRelativeFilePath(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrintDeviceCapabilitiesPackageRelativeFilePath(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrintDeviceResourcesPackageRelativeFilePath() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrintDeviceResourcesPackageRelativeFilePath(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrintDeviceResourcesPackageRelativeFilePath(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrintDeviceResourcesPackageRelativeFilePath(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterPreferredInputFormat) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PreferredInputFormat() const
    {
        winrt::Windows::Devices::Printers::VirtualPrinterPreferredInputFormat value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PreferredInputFormat(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PreferredInputFormat(winrt::Windows::Devices::Printers::VirtualPrinterPreferredInputFormat const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PreferredInputFormat(static_cast<int32_t>(value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterUri() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_PrinterUri(&value));
        return winrt::Windows::Foundation::Uri{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::PrinterUri(winrt::Windows::Foundation::Uri const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_PrinterUri(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::EntryPoint() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->get_EntryPoint(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterInstallationParameters<D>::EntryPoint(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationParameters)->put_EntryPoint(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterInstallationStatus) consume_Windows_Devices_Printers_IVirtualPrinterInstallationResult<D>::Status() const
    {
        winrt::Windows::Devices::Printers::VirtualPrinterInstallationStatus value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationResult)->get_Status(reinterpret_cast<int32_t*>(&value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::hresult) consume_Windows_Devices_Printers_IVirtualPrinterInstallationResult<D>::ExtendedError() const
    {
        winrt::hresult value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterInstallationResult)->get_ExtendedError(put_abi(value)));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterAsync(*(void**)(&parameters), &operation));
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterAsync2(*(void**)(&parameters), *(void**)(&appPackageFamilyName), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterForAllUsersAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterForAllUsersAsync(*(void**)(&parameters), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::InstallVirtualPrinterForAllUsersAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->InstallVirtualPrinterForAllUsersAsync2(*(void**)(&parameters), *(void**)(&appPackageFamilyName), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::FindAllVirtualPrinters() const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->FindAllVirtualPrinters(&result));
        return winrt::Windows::Foundation::Collections::IVectorView<hstring>{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::FindAllVirtualPrinters(param::hstring const& appPackageFamilyName) const
    {
        void* result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->FindAllVirtualPrinters2(*(void**)(&appPackageFamilyName), &result));
        return winrt::Windows::Foundation::Collections::IVectorView<hstring>{ result, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::RemoveVirtualPrinterAsync(param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->RemoveVirtualPrinterAsync(*(void**)(&printerName), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<bool>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) consume_Windows_Devices_Printers_IVirtualPrinterManagerStatics<D>::RemoveVirtualPrinterForAllUsersAsync(param::hstring const& printerName) const
    {
        void* operation{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterManagerStatics)->RemoveVirtualPrinterForAllUsersAsync(*(void**)(&printerName), &operation));
        return winrt::Windows::Foundation::IAsyncOperation<bool>{ operation, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormat<D>::ContentType() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->get_ContentType(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormat<D>::ContentType(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->put_ContentType(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(hstring) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormat<D>::MaxSupportedVersion() const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->get_MaxSupportedVersion(&value));
        return hstring{ value, take_ownership_from_abi };
    }
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormat<D>::MaxSupportedVersion(param::hstring const& value) const
    {
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormat)->put_MaxSupportedVersion(*(void**)(&value)));
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterSupportedFormat) consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormatFactory<D>::CreateInstance(param::hstring const& contentType, param::hstring const& maxSupportedVersion) const
    {
        void* value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Printers::IVirtualPrinterSupportedFormatFactory)->CreateInstance(*(void**)(&contentType), *(void**)(&maxSupportedVersion), &value));
