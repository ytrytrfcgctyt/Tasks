...
{
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Media_Effects_IAcousticEchoCancellationConfiguration<D>::SetEchoCancellationRenderEndpoint(param::hstring const& deviceId) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Media::Effects::AcousticEchoCancellationConfiguration) consume_Windows_Media_Effects_IAudioEffect2<D>::AcousticEchoCancellationConfiguration() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Media_Effects_IAudioEffect2<D>::CanSetState() const
    {
        bool value{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Media::Effects::IAudioEffect2)->get_CanSetState(&value));
        return value;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Media::Effects::AudioEffectState) consume_Windows_Media_Effects_IAudioEffect2<D>::State() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Media_Effects_IAudioEffect2<D>::SetState(winrt::Windows::Media::Effects::AudioEffectState const& newState) const
    {
