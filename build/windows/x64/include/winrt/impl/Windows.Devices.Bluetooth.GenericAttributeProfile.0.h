...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) UpdateAdvertisingParameters(winrt::Windows::Devices::Bluetooth::GenericAttributeProfile::GattServiceProviderAdvertisingParameters const& parameters) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) UseLowEnergyUncoded1MPhyAsSecondaryPhy() const;
        WINRT_IMPL_AUTO(void) UseLowEnergyUncoded1MPhyAsSecondaryPhy(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) UseLowEnergyUncoded2MPhyAsSecondaryPhy() const;
        WINRT_IMPL_AUTO(void) UseLowEnergyUncoded2MPhyAsSecondaryPhy(bool value) const;
    };
