...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) SetEchoCancellationRenderEndpoint(param::hstring const& deviceId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Media::Effects::AcousticEchoCancellationConfiguration) AcousticEchoCancellationConfiguration() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) CanSetState() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Media::Effects::AudioEffectState) State() const;
        WINRT_IMPL_AUTO(void) SetState(winrt::Windows::Media::Effects::AudioEffectState const& newState) const;
    };
