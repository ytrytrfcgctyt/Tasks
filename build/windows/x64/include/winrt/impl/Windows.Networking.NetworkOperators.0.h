...
namespace winrt::impl
{
    ...
    struct consume_Windows_Networking_NetworkOperators_IMobileBroadbandDeviceServiceCommandEventArgs
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DeviceId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::guid) DeviceServiceId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) EventId() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) CommandReceived(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Networking::NetworkOperators::MobileBroadbandDeviceServiceCommandSession, winrt::Windows::Networking::NetworkOperators::MobileBroadbandDeviceServiceCommandEventArgs> const& handler) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) IccId() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(bool) IsAuthenticationKindSupported(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind const& authenticationKind) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) IsAuthenticationKindSupportedAsync(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind const& authenticationKind) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind) AuthenticationKind() const;
        WINRT_IMPL_AUTO(void) AuthenticationKind(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Networking::NetworkOperators::NetworkOperatorTetheringOperationResult>) StartTetheringAsync(winrt::Windows::Networking::NetworkOperators::NetworkOperatorTetheringSessionAccessPointConfiguration const& configuration) const;
    };
    ...
    struct consume_Windows_Networking_NetworkOperators_INetworkOperatorTetheringSessionAccessPointConfiguration
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind) AuthenticationKind() const;
        WINRT_IMPL_AUTO(void) AuthenticationKind(winrt::Windows::Networking::NetworkOperators::TetheringWiFiAuthenticationKind const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Networking::NetworkOperators::TetheringWiFiPerformancePriority) PerformancePriority() const;
        WINRT_IMPL_AUTO(void) PerformancePriority(winrt::Windows::Networking::NetworkOperators::TetheringWiFiPerformancePriority const& value) const;
    };
