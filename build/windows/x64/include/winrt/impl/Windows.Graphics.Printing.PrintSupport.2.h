...
{
    struct __declspec(empty_bases) PrintSupportAppInfo : winrt::Windows::Graphics::Printing::PrintSupport::IPrintSupportAppInfo
    {
    ...
    struct __declspec(empty_bases) PrintSupportEnterpriseManagementUIEventArgs : winrt::Windows::Graphics::Printing::PrintSupport::IPrintSupportEnterpriseManagementUIEventArgs
    {
