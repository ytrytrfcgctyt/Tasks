...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) JobIssueDetected(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession, winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobIssueDetectedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) JobIssueDetected(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) JobStatusChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession, winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPrinterJobStatusChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] JobStatusChanged_revoker JobStatusChanged(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobBackgroundSession, winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPrinterJobStatusChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) JobStatusChanged(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobIssueKind) JobIssueKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) SkipSystemErrorToast() const;
        WINRT_IMPL_AUTO(void) SkipSystemErrorToast(bool value) const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsIppCompressionEnabled() const;
        WINRT_IMPL_AUTO(void) DisableIppCompressionForJob() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) SkipSystemFaxUI() const;
        WINRT_IMPL_AUTO(void) SkipSystemFaxUI(bool value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::event_token) VirtualPrinterUIDataAvailable(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowJobUISession, winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowVirtualPrinterUIEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) VirtualPrinterUIDataAvailable(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<hstring, winrt::Windows::Devices::Printers::IppAttributeValue>) ConvertPrintTicketToJobAttributes(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& printTicket, param::hstring const& targetPdlFormat) const;
    };
    ...
    struct consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowVirtualPrinterDataAvailableEventArgs
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) GetJobPrintTicket() const;
        WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConverter) GetPdlConverter(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowPdlConversionType const& conversionType) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::StorageFile>) GetTargetFileAsync() const;
        WINRT_IMPL_AUTO(void) CompleteJob(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowSubmittedStatus const& status) const;
    };
    ...
    struct consume_Windows_Graphics_Printing_Workflow_IPrintWorkflowVirtualPrinterSession
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowSessionStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDevice) Printer() const;
        WINRT_IMPL_AUTO(winrt::event_token) VirtualPrinterDataAvailable(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowVirtualPrinterSession, winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowVirtualPrinterDataAvailableEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) VirtualPrinterDataAvailable(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(void) Start() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::Workflow::PrintWorkflowVirtualPrinterSession) VirtualPrinterSession() const;
    };
