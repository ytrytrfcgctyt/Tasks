...
namespace winrt::impl
{
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_ITransferTarget
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Streams::IRandomAccessStreamReference) DisplayIcon() const;
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::DataTransfer::TransferTarget) Target() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::DataTransfer::DataPackageView) DataPackage() const;
        [[nodiscard]] WINRT_IMPL_AUTO(int32_t) MaxAppTargets() const;
        WINRT_IMPL_AUTO(void) MaxAppTargets(int32_t value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(com_array<hstring>) AllowedTargetAppIds() const;
        WINRT_IMPL_AUTO(void) AllowedTargetAppIds(array_view<hstring const> value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::DataTransfer::TransferTargetDiscoveryOptions) CreateInstance(winrt::Windows::ApplicationModel::DataTransfer::DataPackageView const& dataPackage) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher) CreateWatcher(winrt::Windows::ApplicationModel::DataTransfer::TransferTargetDiscoveryOptions const& options) const;
    };
    ...
    struct consume_Windows_ApplicationModel_DataTransfer_ITransferTargetWatcher
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetInvokeResult, double>) TransferToAsync(winrt::Windows::ApplicationModel::DataTransfer::TransferTarget const& target, winrt::Windows::UI::WindowId const& parentWindowHandle) const;
        WINRT_IMPL_AUTO(winrt::event_token) Added(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] Added_revoker Added(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) Added(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) Removed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] Removed_revoker Removed(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) Removed(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) Updated(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        ...
        [[nodiscard]] Updated_revoker Updated(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::ApplicationModel::DataTransfer::TransferTargetChangedEventArgs> const& handler) const;
        WINRT_IMPL_AUTO(void) Updated(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) EnumerationCompleted(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] EnumerationCompleted_revoker EnumerationCompleted(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const;
        WINRT_IMPL_AUTO(void) EnumerationCompleted(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) Stopped(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        [[nodiscard]] Stopped_revoker Stopped(auto_revoke_t, winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::ApplicationModel::DataTransfer::TransferTargetWatcher, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(bool) IsSupported(winrt::Windows::ApplicationModel::DataTransfer::DataPackageView const& dataPackage) const;
    };
