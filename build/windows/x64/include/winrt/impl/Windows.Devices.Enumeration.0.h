...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) UserPromptRequired() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) AddPairingSetMember(winrt::Windows::Devices::Enumeration::DeviceInformation const& device) const;
        WINRT_IMPL_AUTO(winrt::event_token) PairingSetMembersRequested(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Enumeration::DeviceInformationCustomPairing, winrt::Windows::Devices::Enumeration::DevicePairingSetMembersRequestedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) PairingSetMembersRequested(winrt::event_token const& token) const noexcept;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Enumeration::DeviceInformation>) CreateFromIdAsync(param::hstring const& deviceId, param::async_iterable<hstring> const& additionalProperties, winrt::Windows::Devices::Enumeration::DeviceInformationKind const& kind, winrt::Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Enumeration::DeviceInformationCollection>) FindAllAsync(param::hstring const& aqsFilter, param::async_iterable<hstring> const& additionalProperties, winrt::Windows::Devices::Enumeration::DeviceInformationKind const& kind, winrt::Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const;
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Enumeration::DeviceWatcher) CreateWatcher(param::hstring const& aqsFilter, param::iterable<hstring> const& additionalProperties, winrt::Windows::Devices::Enumeration::DeviceInformationKind const& kind, winrt::Windows::Devices::Enumeration::IDeviceEnumerationSettings const& settings) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(void) AcceptWithAddress(param::hstring const& address) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Enumeration::DevicePairingAddPairingSetMemberStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Enumeration::DeviceInformation) ParentDeviceInformation() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::Enumeration::DeviceInformation>) PairingSetMembers() const;
    };
