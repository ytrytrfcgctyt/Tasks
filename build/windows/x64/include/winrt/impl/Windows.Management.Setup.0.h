...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentAgentProgressState) State() const;
        WINRT_IMPL_AUTO(void) State(winrt::Windows::Management::Setup::DeploymentAgentProgressState const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(double) ProgressPercentage() const;
        WINRT_IMPL_AUTO(void) ProgressPercentage(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::TimeSpan) EstimatedTimeRemaining() const;
        WINRT_IMPL_AUTO(void) EstimatedTimeRemaining(winrt::Windows::Foundation::TimeSpan const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DisplayProgress() const;
        WINRT_IMPL_AUTO(void) DisplayProgress(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DisplayProgressSecondary() const;
        WINRT_IMPL_AUTO(void) DisplayProgressSecondary(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Management::Setup::DeploymentWorkloadBatch>) Batches() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) CurrentBatchIndex() const;
        WINRT_IMPL_AUTO(void) CurrentBatchIndex(uint32_t value) const;
    };
    ...
    struct consume_Windows_Management_Setup_IDeploymentSessionConnectionChangedEventArgs
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentSessionConnectionChange) Change() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) SessionId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentSessionStateChange) Change() const;
    };
    ...
    struct consume_Windows_Management_Setup_IDeploymentWorkload
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DisplayFriendlyName() const;
        WINRT_IMPL_AUTO(void) DisplayFriendlyName(param::hstring const& value) const;
        ...
        WINRT_IMPL_AUTO(void) ErrorMessage(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PossibleCause() const;
        WINRT_IMPL_AUTO(void) PossibleCause(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PossibleResolution() const;
        WINRT_IMPL_AUTO(void) PossibleResolution(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentWorkloadState) State() const;
        WINRT_IMPL_AUTO(void) State(winrt::Windows::Management::Setup::DeploymentWorkloadState const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) StateDetails() const;
        WINRT_IMPL_AUTO(void) StateDetails(param::hstring const& value) const;
    };
    ...
    struct consume_Windows_Management_Setup_IDeploymentWorkloadBatch
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) DisplayCategoryTitle() const;
        WINRT_IMPL_AUTO(void) DisplayCategoryTitle(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Management::Setup::DeploymentWorkload>) BatchWorkloads() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentWorkloadBatch) CreateInstance(uint32_t id) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentWorkload) CreateInstance(param::hstring const& id) const;
    };
    ...
    struct consume_Windows_Management_Setup_IMachineProvisioningProgressReporter
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentSessionConnectionChange) SessionConnection() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::DeploymentSessionStateChange) SessionState() const;
        WINRT_IMPL_AUTO(winrt::event_token) SessionStateChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Management::Setup::MachineProvisioningProgressReporter, winrt::Windows::Management::Setup::DeploymentSessionStateChangedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) SessionStateChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(winrt::event_token) SessionConnectionChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Management::Setup::MachineProvisioningProgressReporter, winrt::Windows::Management::Setup::DeploymentSessionConnectionChangedEventArgs> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) SessionConnectionChanged(winrt::event_token const& token) const noexcept;
        WINRT_IMPL_AUTO(void) ReportProgress(winrt::Windows::Management::Setup::AgentProvisioningProgressReport const& updateReport) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Management::Setup::DevicePreparationExecutionContext>) GetDevicePreparationExecutionContextAsync() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Management::Setup::MachineProvisioningProgressReporter) GetForLaunchUri(winrt::Windows::Foundation::Uri const& launchUri, winrt::Windows::Management::Setup::DeploymentSessionHeartbeatRequested const& heartbeatHandler) const;
    };
