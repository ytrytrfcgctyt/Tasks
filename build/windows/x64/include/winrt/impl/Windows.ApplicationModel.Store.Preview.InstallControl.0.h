...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsAlreadyOwned() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) OrderId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) SkuId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) AvailabilityId() const;
    };
