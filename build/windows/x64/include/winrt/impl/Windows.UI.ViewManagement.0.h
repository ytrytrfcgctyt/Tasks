...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::UI::ViewManagement::UserInteractionMode) GetPreferredInteractionMode(array_view<winrt::Windows::UI::ViewManagement::UserInteractionMode const> supportedModes) const;
        WINRT_IMPL_AUTO(winrt::event_token) PreferredInteractionModeChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::UI::ViewManagement::UIViewSettings, winrt::Windows::Foundation::IInspectable> const& handler) const;
        ...
        WINRT_IMPL_AUTO(void) PreferredInteractionModeChanged(winrt::event_token const& token) const noexcept;
    };
