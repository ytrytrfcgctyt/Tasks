...
namespace winrt::impl
{
    ...
    struct consume_Windows_Media_Audio_IAudioEffectsPackConfiguration
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) EffectsPackId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Media::Audio::AudioEffectsPackStatus) Status() const;
        WINRT_IMPL_AUTO(winrt::event_token) StatusChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Media::Audio::AudioEffectsPackConfiguration, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Media::Audio::AudioEffectsPackConfiguration) GetForDeviceId(param::hstring const& effectsPackId, param::hstring const& deviceId) const;
        WINRT_IMPL_AUTO(bool) IsDeviceIdSupported(param::hstring const& effectsPackId, param::hstring const& deviceId) const;
    };
