...
namespace winrt::impl
{
    ...
    struct consume_Windows_Storage_Provider_IStorageProviderKnownFolderEntry
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderKnownFolderSyncStatus) Status() const;
        WINRT_IMPL_AUTO(void) Status(winrt::Windows::Storage::Provider::StorageProviderKnownFolderSyncStatus const& value) const;
    };
    ...
    struct consume_Windows_Storage_Provider_IStorageProviderKnownFolderSyncInfo
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Storage::Provider::StorageProviderKnownFolderEntry>) KnownFolderEntries() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderKnownFolderSyncRequestedHandler) SyncRequested() const;
        WINRT_IMPL_AUTO(void) SyncRequested(winrt::Windows::Storage::Provider::StorageProviderKnownFolderSyncRequestedHandler const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderKnownFolderSyncInfo) GetKnownFolderSyncInfo() const;
        WINRT_IMPL_AUTO(winrt::event_token) KnownFolderSyncInfoChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Storage::Provider::IStorageProviderKnownFolderSyncInfoSource, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::IStorageProviderKnownFolderSyncInfoSource) GetKnownFolderSyncInfoSource() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::guid>) KnownFolders() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::StorageFolder) Source() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderResultKind) Kind() const;
        WINRT_IMPL_AUTO(void) Kind(winrt::Windows::Storage::Provider::StorageProviderResultKind const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ResultId() const;
        WINRT_IMPL_AUTO(void) ResultId(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) RemoteFileId() const;
        WINRT_IMPL_AUTO(void) RemoteFileId(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FilePath() const;
        WINRT_IMPL_AUTO(void) FilePath(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::PropertySet) RequestedProperties() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(com_array<winrt::Windows::Storage::Provider::IStorageProviderQueryResult>) GetResults() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) QueryResultId() const;
        WINRT_IMPL_AUTO(void) QueryResultId(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderSearchQueryStatus) Status() const;
        WINRT_IMPL_AUTO(void) Status(winrt::Windows::Storage::Provider::StorageProviderSearchQueryStatus const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderQueryResultSet) CreateInstance(array_view<winrt::Windows::Storage::Provider::IStorageProviderQueryResult const> results) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderQueryResultSet) Find(winrt::Windows::Storage::Provider::StorageProviderSearchQueryOptions const& options) const;
        WINRT_IMPL_AUTO(void) ReportUsage(winrt::Windows::Storage::Provider::StorageProviderResultUsageKind const& resultUsageKind, param::hstring const& remoteFileId, param::hstring const& resultId, winrt::Windows::Foundation::TimeSpan const& latency) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::IStorageProviderSearchHandler) CreateSearchHandler(param::hstring const& cloudProviderId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) UserQuery() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) Language() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Storage::Search::SortEntry>) SortOrder() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) ProgrammaticQuery() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) MaxResults() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) FolderScope() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) QueryId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) PropertiesToFetch() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(double) MatchScore() const;
        WINRT_IMPL_AUTO(void) MatchScore(double value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderSearchMatchKind) MatchKind() const;
        WINRT_IMPL_AUTO(void) MatchKind(winrt::Windows::Storage::Provider::StorageProviderSearchMatchKind const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) MatchedPropertyName() const;
        WINRT_IMPL_AUTO(void) MatchedPropertyName(param::hstring const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Foundation::Uri>) CreateLinkAsync(param::async_vector_view<winrt::Windows::Storage::IStorageItem> const& storageItemList) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<hstring>) GetDefaultAccessControlStringAsync(param::async_vector_view<winrt::Windows::Storage::IStorageItem> const& storageItemList) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Storage::Provider::StorageProviderShareLinkState>) GetState(param::async_vector_view<winrt::Windows::Storage::IStorageItem> const& storageItemList) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderQueryResultSet) GetSuggestions(winrt::Windows::Storage::Provider::StorageProviderSuggestionsQueryOptions const& options) const;
        WINRT_IMPL_AUTO(void) Add(winrt::Windows::Storage::Provider::StorageProviderResultKind const& kind, param::hstring const& remoteFileId) const;
        WINRT_IMPL_AUTO(void) Remove(winrt::Windows::Storage::Provider::StorageProviderResultKind const& kind, param::hstring const& remoteFileId) const;
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderSuggestionResult) GetDetails(param::hstring const& remoteFileId, array_view<hstring const> propertiesToFetch, param::hstring const& queryId) const;
        WINRT_IMPL_AUTO(void) ReportUsage(winrt::Windows::Storage::Provider::StorageProviderResultUsageKind const& resultUsageKind, param::hstring const& remoteFileId, param::hstring const& resultId, winrt::Windows::Foundation::TimeSpan const& latency) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::IStorageProviderSuggestionsHandler) CreateSuggestionsHandler(param::hstring const& cloudProviderId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Storage::Provider::StorageProviderResultKind) SuggestionsKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) RemoteFileId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint32_t) MaxResults() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) QueryId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) PropertiesToFetch() const;
