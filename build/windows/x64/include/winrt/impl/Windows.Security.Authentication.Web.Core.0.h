...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse) CreateWithAccount(winrt::Windows::Security::Credentials::WebAccount const& webAccount) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResponse) ResponseData() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountStatus) ResponseStatus() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationAddAccountResult>) AddAccountWithTransferTokenAsync(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest const& request) const;
    };
    ...
    struct consume_Windows_Security_Authentication_Web_Core_IWebAuthenticationTransferTokenRequest
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) TransferToken() const;
        WINRT_IMPL_AUTO(void) TransferToken(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IMap<hstring, hstring>) Properties() const;
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest) Create(winrt::Windows::Security::Credentials::WebAccountProvider const& provider, param::hstring const& transferToken) const;
        WINRT_IMPL_AUTO(winrt::Windows::Security::Authentication::Web::Core::WebAuthenticationTransferTokenRequest) CreateWithCorrelationId(winrt::Windows::Security::Credentials::WebAccountProvider const& provider, param::hstring const& transferToken, param::hstring const& correlationId) const;
    };
