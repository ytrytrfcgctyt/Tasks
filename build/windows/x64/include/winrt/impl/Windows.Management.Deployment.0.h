...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) DeferAutomaticRegistration() const;
        WINRT_IMPL_AUTO(void) DeferAutomaticRegistration(bool value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperationWithProgress<winrt::Windows::Management::Deployment::DeploymentResult, winrt::Windows::Management::Deployment::DeploymentProgress>) RemovePackageByUriAsync(winrt::Windows::Foundation::Uri const& packageUri, winrt::Windows::Management::Deployment::RemovePackageOptions const& options) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(bool) IsPackageRemovalPending(param::hstring const& packageFullName) const;
        WINRT_IMPL_AUTO(bool) IsPackageRemovalPendingForUser(param::hstring const& packageFullName, param::hstring const& userSecurityId) const;
        WINRT_IMPL_AUTO(bool) IsPackageRemovalPendingByUri(winrt::Windows::Foundation::Uri const& packageUri) const;
        WINRT_IMPL_AUTO(bool) IsPackageRemovalPendingByUriForUser(winrt::Windows::Foundation::Uri const& packageUri, param::hstring const& userSecurityId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) DeferRemovalWhenPackagesAreInUse() const;
        WINRT_IMPL_AUTO(void) DeferRemovalWhenPackagesAreInUse(bool value) const;
    };
