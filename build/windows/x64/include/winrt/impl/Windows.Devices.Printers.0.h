...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsIppFaxOutPrinter() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDeviceKind) DeviceKind() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) CanModifyUserDefaultPrintTicket() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket) UserDefaultPrintTicket() const;
        WINRT_IMPL_AUTO(void) UserDefaultPrintTicket(winrt::Windows::Graphics::Printing::PrintTicket::WorkflowPrintTicket const& value) const;
        WINRT_IMPL_AUTO(void) RefreshPrintDeviceCapabilities() const;
        WINRT_IMPL_AUTO(hstring) GetMaxSupportedPdlVersion(param::hstring const& pdlContentType) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::ValueSet) GetDeviceProperties() const;
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::ReplaceDevicePropertiesResult) ReplaceDeviceProperties(param::iterable<winrt::Windows::Foundation::Collections::IKeyValuePair<hstring, winrt::Windows::Foundation::IInspectable>> const& deviceProperties) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::IppPrintDeviceInstallationStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) InstalledPrinterName() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(bool) CanInstallIppPrintDevice() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::IppPrintDeviceInstallationResult>) InstallIppPrintDeviceAsync(winrt::Windows::Foundation::Uri const& printerUri, param::hstring const& printerName) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::ReplaceDevicePropertiesStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PrinterName() const;
        WINRT_IMPL_AUTO(void) PrinterName(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<hstring>) OutputFileExtensions() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVector<winrt::Windows::Devices::Printers::VirtualPrinterSupportedFormat>) SupportedInputFormats() const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PrintDeviceCapabilitiesPackageRelativeFilePath() const;
        WINRT_IMPL_AUTO(void) PrintDeviceCapabilitiesPackageRelativeFilePath(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) PrintDeviceResourcesPackageRelativeFilePath() const;
        WINRT_IMPL_AUTO(void) PrintDeviceResourcesPackageRelativeFilePath(param::hstring const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterPreferredInputFormat) PreferredInputFormat() const;
        WINRT_IMPL_AUTO(void) PreferredInputFormat(winrt::Windows::Devices::Printers::VirtualPrinterPreferredInputFormat const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::Uri) PrinterUri() const;
        WINRT_IMPL_AUTO(void) PrinterUri(winrt::Windows::Foundation::Uri const& value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) EntryPoint() const;
        WINRT_IMPL_AUTO(void) EntryPoint(param::hstring const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterInstallationStatus) Status() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::hresult) ExtendedError() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) InstallVirtualPrinterAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) InstallVirtualPrinterAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) InstallVirtualPrinterForAllUsersAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Printers::VirtualPrinterInstallationResult>) InstallVirtualPrinterForAllUsersAsync(winrt::Windows::Devices::Printers::VirtualPrinterInstallationParameters const& parameters, param::hstring const& appPackageFamilyName) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) FindAllVirtualPrinters() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<hstring>) FindAllVirtualPrinters(param::hstring const& appPackageFamilyName) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) RemoveVirtualPrinterAsync(param::hstring const& printerName) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<bool>) RemoveVirtualPrinterForAllUsersAsync(param::hstring const& printerName) const;
    };
    ...
    struct consume_Windows_Devices_Printers_IVirtualPrinterSupportedFormat
    {
        ...
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) MaxSupportedVersion() const;
        WINRT_IMPL_AUTO(void) MaxSupportedVersion(param::hstring const& value) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Printers::VirtualPrinterSupportedFormat) CreateInstance(param::hstring const& contentType, param::hstring const& maxSupportedVersion) const;
    };
