...
namespace winrt::impl
{
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsIndirectDisplayDevice() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayAdapter) PreferredRenderAdapter() const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Graphics::DisplayAdapterId) RenderAdapterId() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayManagerResultWithState) TryReadCurrentStateForModeQuery() const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayDevice) CreateDisplayDeviceForIndirectAdapter(winrt::Windows::Devices::Display::Core::DisplayAdapter const& indirectAdapter, winrt::Windows::Devices::Display::Core::DisplayAdapter const& renderAdapter) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayPresentationRate) PhysicalPresentationRate() const;
    };
    ...
    struct consume_Windows_Devices_Display_Core_IDisplayMuxDevice
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::Collections::IVectorView<winrt::Windows::Devices::Display::Core::DisplayTarget>) GetAvailableMuxTargets() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayTarget) CurrentTarget() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayTarget) PreferredTarget() const;
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsAutomaticTargetSwitchingEnabled() const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) SetPreferredTarget(winrt::Windows::Devices::Display::Core::DisplayTarget const& target) const;
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncAction) SetAutomaticTargetSwitching() const;
        WINRT_IMPL_AUTO(winrt::event_token) Changed(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Display::Core::DisplayMuxDevice, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    struct consume_Windows_Devices_Display_Core_IDisplayMuxDeviceStatics
    {
        ...
        WINRT_IMPL_AUTO(winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::Devices::Display::Core::DisplayMuxDevice>) FromIdAsync(param::hstring const& deviceInterfaceId) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Foundation::IReference<winrt::Windows::Devices::Display::Core::DisplayPresentationRate>) PhysicalPresentationRate() const;
        WINRT_IMPL_AUTO(void) PhysicalPresentationRate(winrt::Windows::Foundation::IReference<winrt::Windows::Devices::Display::Core::DisplayPresentationRate> const& value) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplaySourceStatus) Status() const;
        WINRT_IMPL_AUTO(winrt::event_token) StatusChanged(winrt::Windows::Foundation::TypedEventHandler<winrt::Windows::Devices::Display::Core::DisplaySource, winrt::Windows::Foundation::IInspectable> const& handler) const;
    ...
    {
        WINRT_IMPL_AUTO(void) SetSignal(winrt::Windows::Devices::Display::Core::DisplayTaskSignalKind const& signalKind, winrt::Windows::Devices::Display::Core::DisplayFence const& fence) const;
    };
    ...
    {
        WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayTaskResult) TryExecuteTask(winrt::Windows::Devices::Display::Core::DisplayTask const& task) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplayPresentStatus) PresentStatus() const;
        [[nodiscard]] WINRT_IMPL_AUTO(uint64_t) PresentId() const;
        [[nodiscard]] WINRT_IMPL_AUTO(winrt::Windows::Devices::Display::Core::DisplaySourceStatus) SourceStatus() const;
    };
